...
function SideNav() {
  ...
  const navItems = [
    { name: "home", logo: homeLogo, alt: "Link to home page" },
    { name: "movies", logo: moviesLogo, alt: "Link to movies index page" },
    { name: "tv-series", logo: tvSeriesLogo, alt: "Link to TV series page" },
    {
      name: "bookmarks",
      logo: bookmarkLogo,
